...
class UserRepositoryClass {
  ...
  async getUserMfaVerificated(id) {
    return await User.findById(id, { mfa_verificated: 1 });
  }
  ...
  async updateUserMfaVerificated(id, mfaVerificated) {
    return await User.findByIdAndUpdate(id, {
      mfa_verificated: mfaVerificated,
    });
  }
